    ...
    if(!token){
        return(
            <div className="center-align">
                <h3>Faça Login para ver o seu carrinho</h3>
                  ...
                  return(
                      <div style={{display:"flex",margin:"20px"}} key={item._id}>
                          ...
                          <div style={{marginLeft:"20px"}}>
                              ...
                              <h6>{item.quantity} x  R$ {item.product.price}</h6>
    ...
    const TotalPrice = ()=>{
        return(
            <div className="container" style={{display:"flex",justifyContent:"space-between"}}>
                ...
                billingAddress={true}
                zipCode={true}
                stripeKey="pk_test_51IbcBiLfmfzEoMqT18P8MpjcwxeFvnNOaMv54YMEbTCis1znbI12S1rbaCU3GCaz0TnmXFgiD1jK3BwqI9kHnfLN00XoQCCay1"
